...
import math
from fiatlight import FunctionWithGui, AnyDataWithGui, FunctionParameterWithGui
...
class LutImageWithGui(FunctionWithGui[ImageUInt8, ImageUInt8]):
    ...
    def __init__(self) -> None:
        ...
        self.parameters_with_gui = [FunctionParameterWithGui("LUT Params", self.lut_params_with_gui)]
