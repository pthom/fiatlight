...
`AnyDataWithGui[DataType]` manages data of any type with associated GUI callbacks, allowing for custom rendering, editing,
serialization, and event handling within the Fiatlight framework.

See [AnyDataGuiCallbacks](any_data_gui_callbacks) for more information on the GUI callbacks.

[//]: # (This "header" was generated by GPT.)

```python
from fiatlight.fiat_types import JsonDict, DataType, Unspecified, Error, UnspecifiedValue, ErrorValue, DataPresentFunction, DataEditFunction
