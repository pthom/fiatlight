...
@with_fiat_attributes(fiat_tags=["contours", "shape"])
...
@with_fiat_attributes(fiat_tags=["features"])
def matchTemplate(
    image: Image,
    template: Image,
) -> ImageFloat_1:
